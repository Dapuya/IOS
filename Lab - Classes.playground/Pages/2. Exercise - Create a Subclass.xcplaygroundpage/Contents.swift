...
class Fighter: Spaceship{
    var weapon = ""
    var remainingForePower = 5
    
    func fire(){
        if remainingForePower>0{
            remainingForePower -= 1
        }
        else if remainingForePower<0{
...
destroyer.remainingForePower = 10
 ...
 */
// because falcon doesn't have weapon property
/*:
 ...
 */
destroyer.fire()
print(destroyer.remainingForePower)
destroyer.fire()
print(destroyer.remainingForePower)
destroyer.fire()
print(destroyer.remainingForePower)
